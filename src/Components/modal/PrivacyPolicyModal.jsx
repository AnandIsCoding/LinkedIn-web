      ...
      >
        ...
        <div className="overflow-y-auto max-h-[60vh] pr-2 text-gray-700 space-y-6 text-sm sm:text-base leading-relaxed">
          {activeTab === "Privacy Policy" && (
            <>
              <p>
                At <strong>Devlinked</strong>, we are committed to protecting
                your personal information and your right to privacy. This
                privacy notice describes how we might collect, use, and store
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Professional data like experience, education, connections.
                </li>
                <li>
                  Usage data like IP address, browser type, interactions, and
                  cookies.
                </li>
              </ul>
              ...
              <p>
                We use your data to improve your experience, personalize
                suggestions, communicate important updates, ensure security, and
          ...
          {activeTab === "Terms & Conditions" && (
            <>
              ...
              <p>
                These Terms of Use govern your access to and use of Devlinked.
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Do not engage in spamming, harassment, or illegal activity.
                </li>
                <li>
                  Do not copy or reproduce any content without authorization.
                </li>
              </ul>
              ...
              <p>
                Devlinked is not responsible for user-generated content or
                third-party links. We strive for accuracy, but make no
                guarantees regarding information completeness.
              </p>
            </>
          )}
          ...
          {activeTab === "Cookie Policy" && (
            <>
              ...
              <p>
                ...
                us enhance your experience by remembering your settings and
                preferences.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Essential Cookies:</strong> Enable basic features like
                  authentication.
                </li>
                <li>
                ...
                <li>
                  <strong>Preference Cookies:</strong> Remember language and
                  layout choices.
                </li>
              </ul>
